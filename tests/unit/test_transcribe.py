...
class TestChunkSegments:
    ...
    def test_no_duplicate_trailing_overlap_chunk(self, max10_overlap4):
        # flush lands exactly on the last segment -> the trailing overlap is not duplicated
